...
import pytest
import src.reymen.sistem.terminal_backends as _modul
...
def test_calisma_dizini_degistir():
    ...
    try:
        ...
        pytest.skip(
            "Arguman gerekli: reymen.sistem.terminal_backends.calisma_dizini_degistir"
        )
    except Exception as hata:
        pytest.xfail("Runtime hatasi: " + str(hata))
...
def test_ssh_baglantilari_listele():
    ...
    try:
        ...
        pytest.skip(
            "Arguman gerekli: reymen.sistem.terminal_backends.ssh_baglantilari_listele"
        )
    except Exception as hata:
        pytest.xfail("Runtime hatasi: " + str(hata))
