...
def test_hafiza_pluginlerini_yukle():
    ...
    try:
        ...
        pytest.skip(
            "Arguman gerekli: reymen.sistem.plugin_manager.hafiza_pluginlerini_yukle"
        )
    except Exception as hata:
        pytest.xfail("Runtime hatasi: " + str(hata))
...
def test_aktif_hafiza_saglayici():
    ...
    try:
        ...
        pytest.skip(
            "Arguman gerekli: reymen.sistem.plugin_manager.aktif_hafiza_saglayici"
        )
    except Exception as hata:
        pytest.xfail("Runtime hatasi: " + str(hata))
...
def test_hafiza_saglayici_listele():
    ...
    try:
        ...
        pytest.skip(
            "Arguman gerekli: reymen.sistem.plugin_manager.hafiza_saglayici_listele"
        )
    except Exception as hata:
        pytest.xfail("Runtime hatasi: " + str(hata))
