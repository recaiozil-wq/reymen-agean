...
Verifies that:
 ...
 2. User plugins at $ReYMeN_HOME/plugins/model-providers/<name>/ override bundled
...
def test_user_plugin_overrides_bundled(tmp_path, monkeypatch):
    ...
    # Point ReYMeN_HOME at a fresh temp dir
    ...
    user_gmi = ReYMeN_home / "plugins" / "model-providers" / "gmi"
...
def test_general_plugin_manager_skips_model_provider_kind(tmp_path, monkeypatch):
    ...
    from ReYMeN_cli import plugins as plugin_mod
