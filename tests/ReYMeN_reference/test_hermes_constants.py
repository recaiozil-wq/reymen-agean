"""Tests for ReYMeN_constants module."""
...
class TestGetDefaultReYMeNRoot:
    ...
    def test_ReYMeN_home_is_custom_path(self, tmp_path, monkeypatch):
        ...
        custom = tmp_path / "my-ReYMeN-data"
        custom.mkdir()
        monkeypatch.setattr(Path, "home", lambda: tmp_path)
...
class TestIsContainer:
    ...
    def _reset_cache(self, monkeypatch):
        ...
        monkeypatch.setattr(ReYMeN_constants, "_container_detected", None)
    ...
    def test_caches_result(self, monkeypatch):
        ...
        monkeypatch.setattr(ReYMeN_constants, "_container_detected", True)
        assert is_container() is True
...
class TestSecureParentDir:
    ...
    def test_safe_path_calls_chmod(self, tmp_path, monkeypatch):
        ...
        safe_dir = tmp_path / "home" / "user" / ".ReYMeN"
