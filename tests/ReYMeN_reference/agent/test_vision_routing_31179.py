...
def isolated_home(monkeypatch):
    """Temp ReYMeN_HOME with config + clean credential env vars."""
    test_home = tempfile.mkdtemp(prefix="ReYMeN_test_31179_")
    ReYMeN_home = os.path.join(test_home, ".ReYMeN")
    os.makedirs(ReYMeN_home)
