...
def _isolate_env(monkeypatch, tmp_path):
    ...
    for key in (
        ...
        "ReYMeN_GEMINI_CLIENT_SECRET",
        "ReYMeN_GEMINI_PROJECT_ID",
...
class TestClientCredResolution:
    def test_env_override(self, monkeypatch):
        ...
        monkeypatch.setenv("ReYMeN_GEMINI_CLIENT_ID", "custom-id.apps.googleusercontent.com")
...
class TestProjectIdResolution:
    ...
    def test_priority_order(self, monkeypatch):
        ...
        monkeypatch.setenv("ReYMeN_GEMINI_PROJECT_ID", "higher-priority")
...
class TestHeadlessDetection:
    ...
    def test_detects_ReYMeN_headless(self, monkeypatch):
        from agent.google_oauth import _is_headless

        monkeypatch.setenv("ReYMeN_HEADLESS", "1")
        assert _is_headless() is True
...
class TestProviderRegistration:
    ...
    def test_oauth_capable_set_preserves_existing(self):
        from ReYMeN_cli.auth_commands import _OAUTH_CAPABLE_PROVIDERS
...
class TestAuthStatus:
    def test_not_logged_in(self):
        from ReYMeN_cli.auth import get_auth_status
...
class TestGquotaCommand:
    def test_gquota_registered(self):
        from ReYMeN_cli.commands import COMMANDS
