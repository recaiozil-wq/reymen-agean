...
def http_server(tmp_path, monkeypatch):
    """Spin up a localhost HTTP server and isolate ReYMeN_HOME under tmp_path."""
...
class TestSaveUrlImage:
    def test_writes_real_bytes_to_ReYMeN_home_cache(self, http_server):
        base, _ = http_server
        ...
        # The cache directory must be under ReYMeN_HOME — gateway cleanup
