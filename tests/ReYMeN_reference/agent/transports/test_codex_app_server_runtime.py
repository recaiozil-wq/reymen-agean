...
class TestSpawnEnvIsolation:
    ...
    def test_kanban_worker_adds_only_kanban_writable_root(self, monkeypatch):
        ...
        danger-full-access. ReYMeN passes a narrow app-server config override
        ...
        monkeypatch.setenv(
            "ReYMeN_KANBAN_DB",
            "/users/alice/.ReYMeN/kanban/boards/smoke/kanban.db",
        )
        ...
        assert (
            'sandbox_workspace_write.writable_roots=["/users/alice/.ReYMeN/kanban/boards/smoke"]'
            in cmd
        )
