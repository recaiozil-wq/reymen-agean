"""Tests for the ReYMeN-tools-as-MCP server module surface.
...
class TestModuleSurface:
    ...
    def test_expected_ReYMeN_specific_tools_listed(self):
    ...
    def test_kanban_worker_tools_exposed(self):
        """Kanban workers run as `ReYMeN chat -q` subprocesses; if they
...
class TestMain:
    def test_main_returns_2_when_mcp_unavailable(self, monkeypatch):
        ...
        import agent.transports.ReYMeN_tools_mcp_server as m
