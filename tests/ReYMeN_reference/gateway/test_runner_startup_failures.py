...
async def test_start_gateway_verbosity_imports_redacting_formatter(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("ReYMeN_logging.setup_logging", lambda ReYMeN_home, mode: tmp_path)
    monkeypatch.setattr("ReYMeN_logging._add_rotating_handler", lambda *args, **kwargs: None)
