...
from ReYMeN_cli.plugins import (  # noqa: E402
    PluginContext,
    PluginManager,
    PluginManifest,
)
...
class TestSlackAdapterPluginActionWiring:
    ...
    def test_plugin_handler_wired_into_app(self):
        ...
        assert "ReYMeN_approve_once" in action_ids
        assert "ReYMeN_deny" in action_ids
    ...
    def test_plugin_loader_failure_does_not_break_connect(self):
        ...
        with patch.object(_slack_mod, "AsyncApp", return_value=mock_app), patch.object(
            ...
            "ReYMeN_cli.plugins.get_plugin_manager",
