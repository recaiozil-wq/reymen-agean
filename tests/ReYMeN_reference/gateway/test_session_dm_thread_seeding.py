...
def store(tmp_path, monkeypatch):
    ...
    ~/.ReYMeN/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at ReYMeN_state import time, before pytest's ReYMeN_HOME monkeypatch
    fires — the autouse fixture's ReYMeN_HOME override doesn't help here.)
    """
    import ReYMeN_state
