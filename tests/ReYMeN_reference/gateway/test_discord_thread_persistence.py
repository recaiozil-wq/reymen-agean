...
being persisted to ~/.ReYMeN/discord_threads.json.
"""
...
class TestDiscordThreadPersistence:
    ...
    def _make_adapter(self, tmp_path):
        """Build a minimal DiscordAdapter with ReYMeN_HOME pointed at tmp_path."""
    ...
    def test_missing_ReYMeN_home_does_not_crash(self, tmp_path):
