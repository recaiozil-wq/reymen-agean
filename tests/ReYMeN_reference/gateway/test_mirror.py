...
class TestFindSessionId:
    def test_finds_matching_session(self, tmp_path):
        ...
        with patch.object(mirror_mod, "_SESSIONS_DIR", sessions_dir), patch.object(
            mirror_mod, "_SESSIONS_INDEX", index_file
        ):
...
class TestAppendToSqlite:
    def test_connection_is_closed_after_use(self, tmp_path):
        ...
        with patch("ReYMeN_state.SessionDB", return_value=mock_db):
