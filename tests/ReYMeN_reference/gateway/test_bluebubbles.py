...
class TestBlueBubblesHelpers:
    ...
    def test_clean_mention_text_strips_leading_wake_word(self, monkeypatch):
        ...
        assert (
            adapter._clean_mention_text("ReYMeN agent: summarize this")
            == "summarize this"
        )
        assert (
            adapter._clean_mention_text("please ask ReYMeN about this")
            == "please ask ReYMeN about this"
        )
