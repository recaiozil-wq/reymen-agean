"""
Tests for mcp_serve — ReYMeN MCP server.
...
def _isolate_ReYMeN_home(tmp_path, monkeypatch):
    """Redirect ReYMeN_HOME to a temp directory."""
...
def _create_test_db(db_path, session_id, messages):
    """Create a minimal SQLite DB mimicking ReYMeN_state schema."""
