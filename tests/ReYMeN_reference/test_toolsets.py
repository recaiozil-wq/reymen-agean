...
class TestToolsetConsistency:
    ...
    def test_ReYMeN_platforms_share_core_tools(self):
        """All ReYMeN-* platform toolsets share the same core tools.
...
class TestDefaultPlatformWebSearchCoverage:
    def test_ReYMeN_whatsapp_toolset_includes_web_search(self):
        assert "web_search" in resolve_toolset("ReYMeN-whatsapp")

    def test_ReYMeN_api_server_toolset_includes_web_search(self):
        assert "web_search" in resolve_toolset("ReYMeN-api-server")
