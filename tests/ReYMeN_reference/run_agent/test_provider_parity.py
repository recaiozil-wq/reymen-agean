...
class TestAuxiliaryClientProviderPriority:
    ...
    def test_nous_when_no_openrouter(self, monkeypatch):
        ...
        with patch(
            "agent.auxiliary_client._read_nous_auth", return_value=nous_auth
        ), patch("agent.auxiliary_client.OpenAI") as mock, patch(
    ...
    def test_codex_not_in_auto_fallback(self, monkeypatch):
        ...
        with patch("agent.auxiliary_client._read_nous_auth", return_value=None), patch(
            "agent.auxiliary_client._read_codex_access_token", return_value="codex-tok"
