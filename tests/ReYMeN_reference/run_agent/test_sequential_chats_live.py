...
AlexKucera reported on Discord (2026-04-16) that after ``ReYMeN update`` pulled
...
Opt-in — not part of default CI:
    ReYMeN_LIVE_TESTS=1 pytest tests/run_agent/test_sequential_chats_live.py -v
...
LIVE = os.environ.get("ReYMeN_LIVE_TESTS") == "1"
OR_KEY = os.environ.get("OPENROUTER_API_KEY", "")

pytestmark = [
    pytest.mark.skipif(not LIVE, reason="live-only — set ReYMeN_LIVE_TESTS=1"),
