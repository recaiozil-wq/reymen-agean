"""Tests for the ``ReYMeN prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from ReYMeN_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(ReYMeN_home, memory_text="", user_text=""):
    mem_dir = ReYMeN_home / "memories"
...
def _seed_skill(ReYMeN_home, name, description):
    skill_dir = ReYMeN_home / "skills" / "demo" / name
