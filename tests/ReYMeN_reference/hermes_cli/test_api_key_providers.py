...
from ReYMeN_cli.copilot_auth import _try_gh_cli_token
...
def _clear_provider_env(monkeypatch):
    ...
    monkeypatch.setattr("ReYMeN_cli.auth._load_auth_store", lambda: {})
...
class TestResolveApiKeyProviderCredentials:
    ...
    def test_try_gh_cli_token_uses_homebrew_path_when_not_on_path(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "ReYMeN_cli.copilot_auth.os.access",
        ...
        monkeypatch.setattr("ReYMeN_cli.copilot_auth.subprocess.run", _fake_run)
...
class TestZaiEndpointAutoDetect:
    ...
    def test_probe_success_returns_detected_url(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "ReYMeN_cli.auth.detect_zai_endpoint",
            lambda *a, **kw: {
                "id": "coding-global",
    ...
    def test_env_override_skips_probe(self, monkeypatch):
        ...
        monkeypatch.setattr("ReYMeN_cli.auth.detect_zai_endpoint", _never_called)
        creds = resolve_api_key_provider_credentials("zai")
