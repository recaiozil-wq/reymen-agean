...
The main() function in ReYMeN_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `ReYMeN -c model`
...
def _build_parser():
    """Build a minimal replica of the ReYMeN top-level parser."""
