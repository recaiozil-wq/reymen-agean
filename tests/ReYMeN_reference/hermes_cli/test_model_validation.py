...
def _validate(model, provider="openrouter", api_models=FAKE_API_MODELS, **kw):
    ...
    with patch("ReYMeN_cli.models.fetch_api_models", return_value=api_models), patch(
        "ReYMeN_cli.models.probe_api_models", return_value=probe_payload
    ):
...
class TestProviderModelIds:
    ...
    def test_copilot_prefers_live_catalog(self):
        with patch(
            ...
            "ReYMeN_cli.models._fetch_github_models",
...
class TestFetchApiModels:
    ...
    def test_returns_none_on_network_error(self):
        with patch(
            "ReYMeN_cli.models.urllib.request.urlopen", side_effect=Exception("timeout")
        ):
    ...
    def test_probe_api_models_tries_v1_fallback(self):
        ...
        with patch(
            "ReYMeN_cli.models.urllib.request.urlopen", side_effect=_fake_urlopen
        ):
    ...
    def test_probe_api_models_uses_copilot_catalog(self):
        ...
        with patch(
            "ReYMeN_cli.models.urllib.request.urlopen", return_value=_Resp()
        ) as mock_urlopen:
