...
class TestApply:
    ...
    def test_enable_succeeds_when_codex_present(self):
        ...
        assert "via MCP" in r.message  # ReYMeN-tools callback message
        assert cfg["model"]["openai_runtime"] == "codex_app_server"
    ...
    def test_enable_triggers_mcp_migration(self):
        """Enabling codex_app_server should auto-migrate ReYMeN mcp_servers
        ...
        # User MCP servers are reported (excluding internal ReYMeN-tools)
        ...
        # ReYMeN tool callback announcement
    ...
    def test_disable_does_not_trigger_migration(self):
        ...
        with patch("ReYMeN_cli.codex_runtime_plugin_migration.migrate") as mig:
            r = crs.apply(cfg, "auto")
        assert r.success
