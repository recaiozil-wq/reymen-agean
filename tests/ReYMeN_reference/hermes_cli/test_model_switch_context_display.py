...
class TestResolveDisplayContextLength:
    ...
    def test_custom_providers_override_honored(self):
        ...
        with _p.object(_mm, "get_cached_context_length", return_value=None), _p.object(
            _mm, "fetch_endpoint_model_metadata", return_value={}
        ), _p.object(_mm, "fetch_model_metadata", return_value={}), _p.object(
            _mm, "is_local_endpoint", return_value=False
