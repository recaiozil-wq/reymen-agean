"""Tests for ``ReYMeN_cli.voice`` — the TUI gateway's voice wrapper.
...
class TestNormalizeVoiceRecordKeyForPromptToolkit:
    ...
    # parser rejects alt+c/d/l because ReYMeN-ink reports Alt as
...
class TestFormatVoiceRecordKeyForStatus:
    ...
    def test_ctrl_and_alt_letter_keys_render_canonically(self):
        from ReYMeN_cli.voice import format_voice_record_key_for_status
