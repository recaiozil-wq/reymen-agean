...
class TestPromptPluginEnvVars:
    ...
    def test_prompts_for_missing_var_simple_format(self):
        ...
        with patch("ReYMeN_cli.config.get_env_value", return_value=None), \
    ...
    def test_secret_uses_masked_prompt(self):
        ...
        with patch("ReYMeN_cli.config.get_env_value", return_value=None), \
             patch("ReYMeN_cli.plugins_cmd.masked_secret_prompt", return_value="s3cret") as mock_prompt, \
             patch("ReYMeN_cli.config.save_env_value"):
            _prompt_plugin_env_vars(manifest, console)
