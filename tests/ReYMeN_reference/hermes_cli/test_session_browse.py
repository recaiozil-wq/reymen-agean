"""Tests for the interactive session browser (`ReYMeN sessions browse`).
...
from ReYMeN_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """ReYMeN sessions browse should be parseable."""
