"""Tests that provider selection via `ReYMeN model` always persists correctly.
...
def config_home(tmp_path, monkeypatch):
    """Isolated ReYMeN_HOME with a minimal string-format config."""
...
class TestSaveModelChoiceAlwaysDict:
    def test_string_model_becomes_dict(self, config_home):
        ...
        from ReYMeN_cli.auth import _save_model_choice
...
class TestProviderPersistsAfterModelSave:
    def test_update_config_for_provider_uses_atomic_yaml_write(self, config_home):
        ...
        from ReYMeN_cli.auth import _update_config_for_provider
    ...
    def test_copilot_provider_saved_when_selected(self, config_home):
        ...
        from ReYMeN_cli.main import _model_flow_copilot
        from ReYMeN_cli.config import load_config
        ...
        with patch(
            ...
            "ReYMeN_cli.models.fetch_github_model_catalog",
            return_value=[
                {
                    "id": "gpt-4.1",
            ...
            "ReYMeN_cli.main._prompt_reasoning_effort_selection",
            return_value="high",
        ), patch(
    ...
    def test_copilot_acp_provider_saved_when_selected(self, config_home):
        ...
        from ReYMeN_cli.main import _model_flow_copilot_acp
        from ReYMeN_cli.config import load_config

        with patch(
            "ReYMeN_cli.auth.get_external_process_provider_status",
            return_value={
            ...
            "ReYMeN_cli.auth.resolve_external_process_provider_credentials",
            return_value={
