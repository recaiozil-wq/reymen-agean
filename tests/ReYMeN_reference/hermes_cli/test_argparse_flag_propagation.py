...
subparser, placing the flag BEFORE the subcommand (e.g. 'ReYMeN --yolo chat')
...
def _build_parser():
    """Build the ReYMeN argument parser from the real code.
...
class TestChatVerboseArg:
    ...
    def test_cmd_chat_forwards_none_when_verbose_is_absent(self, monkeypatch):
        ...
        fake_banner = types.ModuleType("ReYMeN_cli.banner")
        ...
        monkeypatch.setitem(sys.modules, "ReYMeN_cli.banner", fake_banner)
...
class TestYoloEnvVar:
    """Verify --yolo sets ReYMeN_YOLO_MODE regardless of flag position.
