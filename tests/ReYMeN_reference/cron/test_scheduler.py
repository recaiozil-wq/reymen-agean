...
class TestRunJobSessionPersistence:
    def test_run_job_passes_session_db_and_cron_platform(self, tmp_path):
        ...
        with patch("cron.scheduler._ReYMeN_home", tmp_path), \
    ...
    def test_run_job_sets_auto_delivery_env_from_dotenv_home_channel(self, tmp_path, monkeypatch):
        ...
        class FakeAgent:
            ...
            def run_conversation(self, *args, **kwargs):
                ...
                seen["platform"] = get_session_env("ReYMeN_CRON_AUTO_DELIVER_PLATFORM") or None
                seen["chat_id"] = get_session_env("ReYMeN_CRON_AUTO_DELIVER_CHAT_ID") or None
                seen["thread_id"] = get_session_env("ReYMeN_CRON_AUTO_DELIVER_THREAD_ID") or None
    ...
    def test_run_job_clears_stale_auto_delivery_thread_id_between_jobs(self, tmp_path, monkeypatch):
        ...
        class FakeAgent:
            ...
            def run_conversation(self, *args, **kwargs):
                ...
                seen.append(
                    {
                        "platform": get_session_env("ReYMeN_CRON_AUTO_DELIVER_PLATFORM") or None,
                        "chat_id": get_session_env("ReYMeN_CRON_AUTO_DELIVER_CHAT_ID") or None,
                        "thread_id": get_session_env("ReYMeN_CRON_AUTO_DELIVER_THREAD_ID") or None,
                    }
                )
                return {"final_response": "ok"}
...
class TestRunJobConfigLogging:
    ...
    def test_bad_config_yaml_is_logged(self, caplog, tmp_path):
        ...
        with patch("cron.scheduler._ReYMeN_home", tmp_path), \
             patch("cron.scheduler._resolve_origin", return_value=None), \
             patch("dotenv.load_dotenv"), \
             patch("ReYMeN_cli.runtime_provider.resolve_runtime_provider",
...
class TestRunJobSkillBacked:
    ...
    def test_run_job_preserves_credential_file_passthrough_into_worker_thread(self, tmp_path):
        ...
        with patch("cron.scheduler._ReYMeN_home", tmp_path), \
             patch("cron.scheduler._resolve_origin", return_value=None), \
             patch("tools.credential_files._resolve_ReYMeN_home", return_value=tmp_path), \
             patch("dotenv.load_dotenv"), \
             patch("ReYMeN_state.SessionDB", return_value=fake_db), \
             patch(
                 "ReYMeN_cli.runtime_provider.resolve_runtime_provider",
