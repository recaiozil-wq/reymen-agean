...
ReYMeN_HOME so the real suggestions.json is never touched.
"""
...
def store(tmp_path, monkeypatch):
    """A cron.suggestions module bound to an isolated ReYMeN_HOME."""
...
class TestCommandHandler:
    def test_bare_lists_pending(self, store):
        ...
        with patch("cron.suggestions.list_pending", store.list_pending):
            from ReYMeN_cli.suggestions_cmd import handle_suggestions_command
