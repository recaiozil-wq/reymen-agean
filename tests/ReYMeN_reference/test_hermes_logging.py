...
class TestSetupLogging:
    ...
    def test_record_factory_installed(self, ReYMeN_home):
        ...
        assert getattr(
            factory, "_ReYMeN_session_injector", False
...
class TestComponentPrefixes:
    ...
    def test_gateway_prefix(self):
        ...
        # under that prefix).
        assert ("gateway", "ReYMeN_plugins") == ReYMeN_logging.COMPONENT_PREFIXES[
            "gateway"
        ]
...
class TestExternalRotationRecovery:
    ...
    def _make_handler(
        self, log_path: Path
    ) -> ReYMeN_logging._ManagedRotatingFileHandler:
