...
class TestForegroundTimeoutCap:
    ...
    def test_foreground_allows_help_variant_for_server_command(self):
        ...
        with patch(
            ...
            ), patch("tools.terminal_tool._last_activity", {"default": 0}), patch(
    ...
    def test_background_not_rejected(self):
        ...
        with patch(
            ...
            with patch(
                ...
                "tools.terminal_tool._check_all_guards", return_value={"approved": True}
            ), patch("tools.process_registry.process_registry", mock_registry), patch(
                "tools.approval.get_current_session_key", return_value=""
            ):
                result = json.loads(
                    terminal_tool(
