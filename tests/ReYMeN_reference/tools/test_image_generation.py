...
class TestGptQualityPinnedToMedium:
    ...
    def test_resolve_gpt_quality_function_is_gone(self, image_tool):
        ...
        assert not hasattr(
            image_tool, "_resolve_gpt_quality"
...
class TestManagedGatewayErrorTranslation:
    ...
    def test_4xx_translates_to_value_error_with_remediation(
        ...
        """403 from managed gateway → ValueError mentioning FAL_KEY + ReYMeN tools."""
