...
class TestRouteDecision:
    ...
    def test_explicit_override_routes_to_aux_even_for_vision_main(self):
        ...
        with patch.object(
            vision_routing, "_lookup_supports_vision", return_value=True
        ), patch.object(
            vision_routing,
    ...
    def test_non_vision_main_model_routes_to_aux(self):
        ...
        with patch.object(
            vision_routing, "_lookup_supports_vision", return_value=False
        ), patch.object(
            vision_routing,
            "_provider_accepts_multimodal_tool_result",
            return_value=True,
    ...
    def test_unknown_vision_capability_fails_closed(self):
        ...
        with patch.object(
            vision_routing, "_lookup_supports_vision", return_value=None
        ), patch.object(
            vision_routing,
            "_provider_accepts_multimodal_tool_result",
            return_value=True,
...
class TestLookupHelpers:
    ...
    def test_provider_accepts_multimodal_tool_result_returns_none_for_blank_provider(
        self,
    ):
