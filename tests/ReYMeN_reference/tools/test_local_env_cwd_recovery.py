...
Regression coverage for https://github.com/NousResearch/ReYMeN-agent/issues/17558.
"""
    ...
    def test_recovers_when_cwd_deleted_after_init(self, tmp_path, caplog):
        ...
        try:
            with patch(
                ...
                "subprocess.Popen", side_effect=_make_fake_popen(captured, fds)
            ), patch(
                "tools.terminal_tool._interrupt_event", _fake_interrupt()
