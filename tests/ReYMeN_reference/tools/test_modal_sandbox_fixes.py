...
try:
    ...
    pytest.skip(
        "ReYMeN-agent tools not importable (missing deps)", allow_module_level=True
    )
...
class TestCwdHandling:
    ...
    def test_home_path_replaced_for_modal(self, monkeypatch):
        ...
        monkeypatch.setenv("TERMINAL_CWD", "/home/dakota/github/ReYMeN-agent")
...
class TestEphemeralDiskCheck:
    ...
    def test_ephemeral_disk_skipped_when_unsupported(self, monkeypatch):
        ...
        assert (
            "ephemeral_disk" not in sandbox_kwargs
