...
class TestAgentCloseMethod:
    ...
    def test_close_calls_cleanup_functions(self):
        ...
        with patch("run_agent.AIAgent.__init__", return_value=None):
            ...
            ) as mock_registry, patch("run_agent.cleanup_vm") as mock_cleanup_vm, patch(
                "run_agent.cleanup_browser"
            ) as mock_cleanup_browser:
                agent.close()
    ...
    def test_close_survives_partial_failures(self):
        ...
        with patch("run_agent.AIAgent.__init__", return_value=None):
            ...
            with patch("tools.process_registry.process_registry") as mock_reg, patch(
                "run_agent.cleanup_vm"
            ) as mock_vm, patch("run_agent.cleanup_browser") as mock_browser:
...
class TestGatewayCleanupWiring:
    ...
    def test_gateway_stop_calls_close(self):
        ...
        try:
            ...
            ), patch("tools.terminal_tool.cleanup_all_environments"), patch(
