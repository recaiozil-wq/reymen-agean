...
class TestTranscribeAudioE2E:
    ...
    def test_unknown_name_with_plugin_dispatches(self):
        ...
        with patch(
            "tools.transcription_tools._validate_audio_file", return_value=None
        ), patch(
            "tools.transcription_tools._load_stt_config",
            return_value={"provider": "openrouter"},
        ), patch("tools.transcription_tools.is_stt_enabled", return_value=True), patch(
            "tools.transcription_tools._get_provider", return_value="openrouter"
        ):
