...
class TestWebSearchTavily:
    ...
    def test_search_dispatches_to_tavily(self):
        ...
        with patch("tools.web_tools._get_backend", return_value="tavily"), patch.dict(
            os.environ, {"TAVILY_API_KEY": "tvly-test"}
        ), patch("tools.web_tools.httpx.post", return_value=mock_response), patch(
...
class TestWebExtractTavily:
    ...
    def test_extract_dispatches_to_tavily(self):
        ...
        with patch("tools.web_tools._get_backend", return_value="tavily"), patch.dict(
            ...
            "tools.web_tools.process_content_with_llm", return_value=None
        ):
