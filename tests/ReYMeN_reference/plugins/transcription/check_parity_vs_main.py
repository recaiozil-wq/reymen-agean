...
the legacy ``ReYMeN_LOCAL_STT_COMMAND`` escape hatch exists) or this PR's
...
# Isolated ReYMeN_HOME so the config write is hermetic.
...
def main() -> int:
    ...
    if MAIN_DIR == PR_DIR:
        print(
            ...
            "      Set up a sibling 'ReYMeN-agent-main' checkout pinned to "
