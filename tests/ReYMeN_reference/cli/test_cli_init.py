"""Tests for ReYMeNCLI initialization -- catches configuration bugs
...
def _make_cli(env_overrides=None, config_overrides=None, **kwargs):
    """Create a ReYMeNCLI instance with minimal mocking."""
    import importlib
...
class TestMaxTurnsResolution:
    ...
    def test_env_var_max_turns(self):
        ...
        cli_obj = _make_cli(env_overrides={"ReYMeN_MAX_ITERATIONS": "42"})
        assert cli_obj.max_turns == 42

    def test_invalid_env_var_max_turns_falls_back_to_default(self):
        """Invalid env values should not crash CLI init."""
        cli_obj = _make_cli(env_overrides={"ReYMeN_MAX_ITERATIONS": "not-a-number"})
...
class TestHistoryDisplay:
    ...
    def test_history_shows_recent_sessions_when_current_chat_is_empty(self, capsys):
        ...
        cli._session_db.list_sessions_rich.return_value = [
            ...
            },
            {
                ...
                "title": "Checking Running ReYMeN Agent",
                "preview": "check running gateways for ReYMeN agent",
                "last_active": 0,
            },
        ]
        ...
        assert "Checking Running ReYMeN Agent" in output
    ...
    def test_resume_updates_ReYMeN_session_id_env_and_context(self, tmp_path):
        ...
        try:
            ...
            assert os.environ["ReYMeN_SESSION_ID"] == "target_session"
            assert get_session_env("ReYMeN_SESSION_ID") == "target_session"
        finally:
            cli._session_db.close()
            os.environ.pop("ReYMeN_SESSION_ID", None)
            _VAR_MAP["ReYMeN_SESSION_ID"].set(_UNSET)
