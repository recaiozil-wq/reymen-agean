"""Tests for slash command prefix matching in ReYMeNCLI.process_command."""
...
class TestSlashCommandPrefixMatching:
    ...
    def test_unique_prefix_with_args_does_not_recurse(self):
        ...
        with patch.object(
            type(cli_obj), "process_command", counting_process_command
    ...
    def test_exact_command_with_args_does_not_recurse(self):
        ...
        original_pc = ReYMeNCLI.process_command
        ...
        # Mock show_config since the test is about recursion, not config display
        with patch.object(ReYMeNCLI, "process_command", guarded), patch.object(
            cli_obj, "show_config"
        ):
            try:
    ...
    def test_ambiguous_between_builtin_and_skill(self):
        ...
        with patch.object(cli_mod, "_skill_commands", fake_skill), patch.object(
            cli_obj, "show_help"
        ) as mock_help:
            cli_obj.process_command("/help")
