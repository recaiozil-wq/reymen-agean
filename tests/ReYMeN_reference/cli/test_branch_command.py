...
def cli_instance(tmp_path, session_db):
    """Create a minimal ReYMeNCLI-like object for testing _handle_branch_command."""
...
class TestBranchCommandCLI:
    ...
    def test_branch_with_custom_name(self, cli_instance, session_db):
        ...
        ReYMeNCLI._handle_branch_command(cli_instance, "/branch refactor approach")
    ...
    def test_branch_rotates_ReYMeN_session_id_env_and_context(self, cli_instance, session_db):
        ...
        os.environ["ReYMeN_SESSION_ID"] = old_session_id
        _VAR_MAP["ReYMeN_SESSION_ID"].set(old_session_id)

        try:
            ReYMeNCLI._handle_branch_command(cli_instance, "/branch")

            assert cli_instance.session_id != old_session_id
            assert os.environ["ReYMeN_SESSION_ID"] == cli_instance.session_id
            assert get_session_env("ReYMeN_SESSION_ID") == cli_instance.session_id
        finally:
