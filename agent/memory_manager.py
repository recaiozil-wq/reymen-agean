...
class MemoryManager:
    ...
    # -- ReYMeN uyumlu Türkçe API ----------------------------------------

    def kaydet(self, anahtar: str, icerik, tur: str = "task") -> str:
...
# Singleton fabrika (testler `memory_manager(config)` → aynı nesne bekliyor)
_MEMORY_MANAGER_SINGLETON = None

def memory_manager(config=None) -> "MemoryManager":
