...
.. code-block:: yaml
    ...
    branding:
      agent_name: "ReYMeN Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! âš•"              # Shown on exit
      response_label: " âš• ReYMeN "       # Response box header label
    ...
    tool_emojis:
      ...
      web_search: "ğŸ”®"        # Override web_search tool emoji
...
.. code-block:: python
    ...
    from reymen_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "ReYMeN Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.reymen/skins/

BUILT-IN SKINS
==============

- ``default`` â€” Classic ReYMeN gold/kawaii (the current look)
...
Drop a YAML file in ``~/.reymen/skins/<name>.yaml`` following the schema above.
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic ReYMeN â€” gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "ReYMeN Agent",
            "welcome": "Welcome to ReYMeN Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! âš•",
            "response_label": " âš• ReYMeN ",
            "prompt_symbol": "â¯",
...
[dim #4A4A4A]â €â €â €â €â €â €â €â €â €the boulderâ €â €â €â €â €â €â €â €â €[/]""",
    ...
    "charizard": {
        ...
        "spinner": {
            "waiting_faces": ["(âœ¦)", "(â–²)", "(â—‡)", "(<>)", "(ğŸ”¥)"],
            "thinking_faces": ["(âœ¦)", "(â–²)", "(â—‡)", "(âŒ)", "(ğŸ”¥)"],
            "thinking_verbs": [
...
[#C75B1D]â¢¸â¡Ÿâ €â €â£¿â¡Ÿâ €â €â €ğŸ”¥â €â €â €â €â¢»â£¿â €â €â¢»â¡‡[/]
