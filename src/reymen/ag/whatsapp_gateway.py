...
Baglanti bilgileri .env dosyasindaki su degiskenlerden okunur:
  - WHATSAPP_ACCOUNT_SID â€” Twilio hesap SID'si
  - WHATSAPP_AUTH_TOKEN â€” Twilio auth token (WHATSAPP_API_KEY da kullanilabilir)
  - WHATSAPP_NUMBER    â€” Twilio WhatsApp numarasi (whatsapp:+1415...)
