# -*- coding: utf-8 -*-
"""
skills_hub.py â€” Skills Hub: Topluluk skill'lerini kesfetme, indirme ve yonetme.
...
def _http_get(
    ...
    try:
        ...
        logger.warning("HTTP hatasi [%s]: %s â€” %s", e.code, tam_url[:100], e.reason)
        return None
...
class SkillsHub:
    """Skills Hub â€” topluluk skill'lerini kesfetme, indirme ve yonetme.
    ...
    # â”€â”€ Arama â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ Kategoriler â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ Metadata Detayi â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ Skill Indirme â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ Toplu Indirme / Guncelleme â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        for skill in uzak_skills[:max_indir]:
            try:
                if skill.name in indirilmis:
                    # Zaten indirilmis â€” sadece metadata'yi guncelle
    ...
    # â”€â”€ Durum / Istatistik â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def cron_haftalik_guncelleme(kategori: str = "", max_indir: int = 10) -> dict[str, Any]:
    """Haftalik Skills Hub guncellemesi â€” cron job'u icin dogrudan cagri.
    ...
    if len(sys.argv) > 1:
        ...
        if komut == "ara":
            ...
            for s in sonuclar:
                ...
                print(f"  {s.name} {kat} â€” {s.description[:60]}")
            ...
            if sonuc.basarili:
                print(f"\nâœ“ Indirildi: {sonuc.name} -> {sonuc.hedef_yol}\n")
            else:
                print(f"\nâœ— Hata: {sonuc.hata}\n")
            ...
            for s in liste:
                print(f"  {s['name']} [{s['category']}] â€” {s['description'][:50]}")
            print()
