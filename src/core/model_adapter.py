...
def get_active_adapter() -> ModelAdapter:
    ...
    match provider:
        case "ollama":
            return OllamaAdapter(model or "llama3")
        case "lmstudio":
            return OpenAICompatAdapter("http://localhost:1234", model or "local")
        case "openai":
        ...
        case "anthropic":
            return AnthropicAdapter(model or "claude-3-5-sonnet-20241022")
        case "glm":
            return OpenAICompatAdapter("http://localhost:8000", model or "glm-4")
        case _:
