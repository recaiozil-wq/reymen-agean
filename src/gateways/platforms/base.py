        ...
        try:
            ...
            if logged is None:
                ...
                try:
                    ...
                    log.warning(f"[gateways.platforms.base] Exception")
                    pass
            ...
            while True:
                ...
                if chat_id not in self._typing_paused:
                    try:
                        ...
                        logger.warning(
                            "[Base] except asyncio.TimeoutError (L3180): %s",
        ...
        try:
            if typing_task is not None and not typing_task.done():
                ...
                try:
                    ...
                    logger.warning(
                        "[Base] except (asyncio.CancelledError, asyncio.TimeoutError) (L3236): %s",
        ...
        *,
        ...
        if task is not None and not task.done():
            ...
            try:
                ...
                log.warning(f"[gateways.platforms.base] CancelledError")
                pass
        ...
        try:
                ...
                if _tts_path and Path(_tts_path).exists():
                    try:
                        ...
                        try:
                            ...
                            logger.warning(
                                "[Base] Dosya/klasor hatasi (L4331): %s", OSError
                            )
                            pass
            ...
            if callable(_post_cb):
                try:
                    ...
                    logger.warning(
                        "[Base] except (asyncio.TimeoutError, Exception) (L4597): %s",
                        asyncio.TimeoutError,
                    )
                    pass
