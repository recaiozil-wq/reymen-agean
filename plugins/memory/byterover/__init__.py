...
Working directory: $ReYMeN_HOME/byterover/ (profile-scoped context tree)
"""


__all__ = ['Any', 'ByteRoverMemoryProvider', 'Dict', 'List', 'MemoryProvider', 'Optional', 'Path', 'annotations', 'get_ReYMeN_home', 'get_config_schema', 'get_tool_schemas', 'handle_tool_call', 'initialize', 'is_available', 'name', 'on_memory_write', 'on_pre_compress', 'prefetch', 'queue_prefetch', 'register', 'shutdown', 'sync_turn', 'system_prompt_block', 'tool_error']
...
def _get_brv_cwd() -> Path:
    ...
    return get_ReYMeN_home() / "byterover"
