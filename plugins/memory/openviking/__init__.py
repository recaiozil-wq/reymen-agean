...
Config via environment variables (profile-scoped via each profile's .env):
  ...
  OPENVIKING_AGENT   — Tenant agent (default: ReYMeN)
...
__all__ = ['Any', 'Dict', 'List', 'MemoryProvider', 'OpenVikingMemoryProvider', 'Optional', 'Path', 'annotations', 'get', 'get_config_schema', 'get_tool_schemas', 'handle_tool_call', 'health', 'initialize', 'is_available', 'name', 'on_memory_write', 'on_session_end', 'post', 'prefetch', 'queue_prefetch', 'register', 'shutdown', 'sync_turn', 'system_prompt_block', 'tool_error', 'upload_temp_file', 'url2pathname', 'urlparse']
...
class _VikingClient:
    ...
    def __init__(self, endpoint: str, api_key: str = "",
        ...
        self._agent = agent or os.environ.get("OPENVIKING_AGENT", "ReYMeN")
...
class OpenVikingMemoryProvider(MemoryProvider):
    ...
    def get_config_schema(self):
        return [
            ...
            {
                "key": "agent",
                "description": "OpenViking agent ID within the account ([ReYMeN], useful in multi-agent mode)",
                "default": "ReYMeN",
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._agent = os.environ.get("OPENVIKING_AGENT", "ReYMeN")
    ...
    def _tool_read(self, args: dict) -> str:
        ...
        # (e.g. viking://user/ReYMeN/.overview.md).
