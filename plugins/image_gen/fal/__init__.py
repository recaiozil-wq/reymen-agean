...
__all__ = ['Any', 'DEFAULT_ASPECT_RATIO', 'Dict', 'FalImageGenProvider', 'ImageGenProvider', 'List', 'Optional', 'annotations', 'default_model', 'display_name', 'generate', 'get_setup_schema', 'is_available', 'list_models', 'name', 'register', 'resolve_aspect_ratio']
