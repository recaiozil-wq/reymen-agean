...
__all__ = ['Any', 'DEFAULT_ASPECT_RATIO', 'Dict', 'ImageGenProvider', 'List', 'Optional', 'ReYMeN_xai_user_agent', 'Tuple', 'XAIImageGenProvider', 'annotations', 'display_name', 'error_response', 'generate', 'get_setup_schema', 'is_available', 'list_models', 'load_config', 'name', 'register', 'resolve_aspect_ratio', 'resolve_xai_http_credentials', 'save_b64_image', 'save_url_image', 'success_response']
...
from tools.xai_http import ReYMeN_xai_user_agent, resolve_xai_http_credentials
...
class XAIImageGenProvider(ImageGenProvider):
    ...
    def get_setup_schema(self) -> Dict[str, Any]:
        ...
        # hook (``ReYMeN_cli/tools_config.py``); identical to the TTS / video
        ...
        **kwargs: Any,
        ...
        if not api_key:
            return error_response(
                error="No xAI credentials found. Configure xAI OAuth in `ReYMeN model` or set XAI_API_KEY.",
        ...
        headers = {
            ...
            "User-Agent": ReYMeN_xai_user_agent(),
        }
