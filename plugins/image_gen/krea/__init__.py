...
__all__ = ['Any', 'DEFAULT_ASPECT_RATIO', 'Dict', 'ImageGenProvider', 'KreaImageGenProvider', 'List', 'Optional', 'Tuple', 'annotations', 'default_model', 'display_name', 'error_response', 'generate', 'get_setup_schema', 'is_available', 'list_models', 'load_config', 'name', 'register', 'resolve_aspect_ratio', 'save_url_image', 'success_response']
...
# ReYMeN uses 3 abstract aspect ratios. Map to Krea's enum (which is wider).
    ...
    def generate(
        ...
        **kwargs: Any,
        ...
        if not api_key:
            return error_response(
                error=(
                    "KREA_API_KEY not set. Run `ReYMeN tools` → Image "
        ...
        headers = {
            ...
            "User-Agent": "ReYMeN-Agent/1.0 (krea-image-gen)",
        }
