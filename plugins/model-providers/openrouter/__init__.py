...
__all__ = ['Any', 'OpenRouterProfile', 'ProviderProfile', 'build_api_kwargs_extras', 'build_extra_body', 'fetch_models', 'register_provider']
import logging
...
class OpenRouterProfile(ProviderProfile):
    ...
    def fetch_models(
        ...
        *,
        ...
        Note: Tool-call capability filtering is applied by ReYMeN_cli/models.py
