...
def _state_dir() -> Path:
    ...
    # Default: $ReYMeN_HOME/watcher-state/, falling back to ~/.ReYMeN/watcher-state/.
    ReYMeN_home = os.environ.get("ReYMeN_HOME") or str(Path.home() / ".ReYMeN")
    return Path(ReYMeN_home) / "watcher-state"
