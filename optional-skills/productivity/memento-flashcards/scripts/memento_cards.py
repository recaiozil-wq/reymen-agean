...
Data file: $ReYMeN_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ReYMeN_HOME = Path(os.environ.get("ReYMeN_HOME", Path.home() / ".ReYMeN"))
DATA_DIR = _ReYMeN_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
