#!/usr/bin/env python3
"""Build the ReYMeN Model Catalog — a centralized JSON manifest of curated models.
...
ReYMeN CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a ReYMeN release.
...
``https://ReYMeN-agent.nousresearch.com/docs/api/model-catalog.json``
"""
...
# Ensure ReYMeN_HOME is set for imports that touch it at module level.
os.environ.setdefault("ReYMeN_HOME", os.path.join(os.path.expanduser("~"), ".ReYMeN"))

from ReYMeN_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "ReYMeN-agent repo",
            "docs": "https://ReYMeN-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
