# -*- coding: utf-8 -*-
"""
turn_retry_state.py — Per-attempt recovery bookkeeping for conversation turn loop.

Provides TurnRetryState dataclass for the conversation loop's inner retry
mechanics. Each recovery branch (credential-pool 429 retry, OAuth refresh,
