#!/usr/bin/env python3
"""Build the ReYMeN Skills Index — a centralized JSON catalog of all skills.
...
`ReYMeN skills search/install` can use it without hitting the GitHub API.
...
# Ensure ReYMeN_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building ReYMeN Skills Index...", flush=True)
