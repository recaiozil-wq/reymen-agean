...
DEFAULT_DATASETS = [
    ...
    "NousResearch/ReYMeN-agent-megascience-sft1",
    "NousResearch/ReYMeN-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/ReYMeN-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-ReYMeN-agent"
]
