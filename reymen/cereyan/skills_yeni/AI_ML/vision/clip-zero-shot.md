...
| **Ne** | Run zero-shot image classification with a CLIP / SigLIP checkpoint, producing ranked predictions with similarity scores. |
| **Nerede** | `misc\vision\clip-zero-shot.md` |
| **Ne Zaman** | Genel AI/ML gorevlerinde |
| **Neden** | Clip Zero Shot islemini standartlastirmak icin |
...
Nerede: `misc\vision\clip-zero-shot.md`
Ne Zaman: Genel AI/ML gorevlerinde
Neden: Clip Zero Shot islemini standartlastirmak ve tekrarlanabilir kilmak icin
