...
|:----:|:---------|
| **Kim** | AI muhendisi |
| **Ne** | Map a proposed multi-agent system design to the closest 2026 production reference (Anthropic Research, MetaGPT/ChatDev, or OpenClaw/Moltbook). Surface known trade-offs, recommended framework, and the  |
| **Nerede** | `ai\ecc\case-study-mapper.md` |
| **Ne Zaman** | AI modeli secimi veya degerlendirmesi gerektiginde |
| **Neden** | Case Study Mapper islemini standartlastirmak icin |
...
|:-----|:------|
| **Kim?** | Tüm ajanlar |
| **Ne?** | Map a proposed multi-agent system design to the closest 2026 production reference (Anthropic Research, MetaGPT/ChatDev, or OpenClaw/Moltbook). Surface known trade-offs, recommended framework, and the specific design decisions already tested in production. |
| **Nerede?** | ecc/ |
...
Nerede: `ai\ecc\case-study-mapper.md`
Ne Zaman: AI modeli secimi veya degerlendirmesi gerektiginde
Neden: Case Study Mapper islemini standartlastirmak ve tekrarlanabilir kilmak icin
