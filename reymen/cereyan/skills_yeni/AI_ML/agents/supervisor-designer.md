...
| **Ne** | Design a supervisor/orchestrator-worker system for a given research-style query, specifying lead prompt, worker roles, decomposition rules, and synthesis template. |
| **Nerede** | `misc\agent-systems\supervisor-designer.md` |
| **Ne Zaman** | Genel AI/ML gorevlerinde |
| **Neden** | Supervisor Designer islemini standartlastirmak icin |
...
Nerede: `misc\agent-systems\supervisor-designer.md`
Ne Zaman: Genel AI/ML gorevlerinde
Neden: Supervisor Designer islemini standartlastirmak ve tekrarlanabilir kilmak icin
