...
| **Ne** | Audit a multi-agent system that claims "emergent coordination." Separates real ToM-enabled coordination from prompt-dressed illusion with control conditions, statistical tests, and complementarity mea |
| **Nerede** | `misc\agent-systems\tom-auditor.md` |
| **Ne Zaman** | Genel AI/ML gorevlerinde |
| **Neden** | Tom Auditor islemini standartlastirmak icin |
...
|:-----|:------|
| **Kim?** | Tüm ajanlar |
| **Ne?** | Audit a multi-agent system that claims "emergent coordination." Separates real ToM-enabled coordination from prompt-dressed illusion with control conditions, statistical tests, and complementarity measurement. |
...
Nerede: `misc\agent-systems\tom-auditor.md`
Ne Zaman: Genel AI/ML gorevlerinde
Neden: Tom Auditor islemini standartlastirmak ve tekrarlanabilir kilmak icin
