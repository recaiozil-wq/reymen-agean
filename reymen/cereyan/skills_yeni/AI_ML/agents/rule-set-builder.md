...
| **Ne** | Interview a project owner, classify their existing prose instructions into five operational categories, and emit a versioned agent-rules.md plus a Python checker stub. |
| **Nerede** | `misc\agent-systems\rule-set-builder.md` |
| **Ne Zaman** | Genel AI/ML gorevlerinde |
| **Neden** | Rule Set Builder islemini standartlastirmak icin |
...
Nerede: `misc\agent-systems\rule-set-builder.md`
Ne Zaman: Genel AI/ML gorevlerinde
Neden: Rule Set Builder islemini standartlastirmak ve tekrarlanabilir kilmak icin
