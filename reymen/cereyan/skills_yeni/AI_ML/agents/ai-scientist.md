...
| **Ne** | Build an autonomous research agent that runs experiment tree search, writes LaTeX papers with vision critique, and passes a sandbox-escape red team. |
| **Nerede** | `misc\agent-systems\ai-scientist.md` |
| **Ne Zaman** | Genel AI/ML gorevlerinde |
| **Neden** | Ai Scientist islemini standartlastirmak icin |
...
Nerede: `misc\agent-systems\ai-scientist.md`
Ne Zaman: Genel AI/ML gorevlerinde
Neden: Ai Scientist islemini standartlastirmak ve tekrarlanabilir kilmak icin
