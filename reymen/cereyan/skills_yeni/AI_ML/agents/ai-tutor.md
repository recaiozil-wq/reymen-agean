...
| **Ne** | Ship an adaptive multimodal personal tutor for a specific subject with Bayesian knowledge tracing, a curriculum graph, safety filters, and a measured two-week efficacy study. |
| **Nerede** | `misc\agent-systems\ai-tutor.md` |
| **Ne Zaman** | Genel AI/ML gorevlerinde |
| **Neden** | Ai Tutor islemini standartlastirmak icin |
...
Nerede: `misc\agent-systems\ai-tutor.md`
Ne Zaman: Genel AI/ML gorevlerinde
Neden: Ai Tutor islemini standartlastirmak ve tekrarlanabilir kilmak icin
