...
| **Ne** | Produce a role roster for a multi-agent system, naming the planner/executor/critic/verifier for a given task with explicit I/O schemas. |
| **Nerede** | `misc\agent-systems\role-designer.md` |
| **Ne Zaman** | Genel AI/ML gorevlerinde |
| **Neden** | Role Designer islemini standartlastirmak icin |
...
Nerede: `misc\agent-systems\role-designer.md`
Ne Zaman: Genel AI/ML gorevlerinde
Neden: Role Designer islemini standartlastirmak ve tekrarlanabilir kilmak icin
