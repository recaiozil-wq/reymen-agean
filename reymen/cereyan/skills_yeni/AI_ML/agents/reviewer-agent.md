...
| **Ne** | Stand up a reviewer agent role with a five-dimension rubric that reads builder artifacts, produces a structured review report, and starts human review from a written page instead of a blank one. |
| **Nerede** | `misc\agent-systems\reviewer-agent.md` |
| **Ne Zaman** | Genel AI/ML gorevlerinde |
| **Neden** | Reviewer Agent islemini standartlastirmak icin |
...
Nerede: `misc\agent-systems\reviewer-agent.md`
Ne Zaman: Genel AI/ML gorevlerinde
Neden: Reviewer Agent islemini standartlastirmak ve tekrarlanabilir kilmak icin
