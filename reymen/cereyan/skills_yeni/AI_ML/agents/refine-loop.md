...
| **Ne** | Configure an evaluator-optimizer (Self-Refine / CRITIC) loop given task, verifier availability, and iteration budget. |
| **Nerede** | `misc\agent-systems\refine-loop.md` |
| **Ne Zaman** | Genel AI/ML gorevlerinde |
| **Neden** | Refine Loop islemini standartlastirmak icin |
...
Nerede: `misc\agent-systems\refine-loop.md`
Ne Zaman: Genel AI/ML gorevlerinde
Neden: Refine Loop islemini standartlastirmak ve tekrarlanabilir kilmak icin
