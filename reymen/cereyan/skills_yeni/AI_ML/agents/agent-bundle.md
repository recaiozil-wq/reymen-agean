...
| **Ne** | Produce a portable SKILL.md + AGENTS.md + MCP-server blueprint for a workflow, loadable across Claude Code, Cursor, Codex, and compatible agents. |
| **Nerede** | `misc\agent-systems\agent-bundle.md` |
| **Ne Zaman** | Genel AI/ML gorevlerinde |
| **Neden** | Agent Bundle islemini standartlastirmak icin |
...
Nerede: `misc\agent-systems\agent-bundle.md`
Ne Zaman: Genel AI/ML gorevlerinde
Neden: Agent Bundle islemini standartlastirmak ve tekrarlanabilir kilmak icin
