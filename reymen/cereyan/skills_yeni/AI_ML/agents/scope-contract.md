...
| **Ne** | Generate per-task scope contracts with allowed/forbidden globs, acceptance criteria, and rollback plan, plus a CI-ready glob-aware checker that runs on every agent diff. |
| **Nerede** | `misc\agent-systems\scope-contract.md` |
| **Ne Zaman** | Genel AI/ML gorevlerinde |
| **Neden** | Scope Contract islemini standartlastirmak icin |
...
Nerede: `misc\agent-systems\scope-contract.md`
Ne Zaman: Genel AI/ML gorevlerinde
Neden: Scope Contract islemini standartlastirmak ve tekrarlanabilir kilmak icin
