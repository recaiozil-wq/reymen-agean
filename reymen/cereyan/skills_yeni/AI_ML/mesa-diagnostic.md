...
|:----:|:---------|
| **Kim** | AI muhendisi |
| **Ne** | Classify an observed safety failure as outer-alignment, proxy-inner, or deceptive-inner. |
| **Nerede** | `ai\safety\mesa-diagnostic.md` |
| **Ne Zaman** | AI modeli secimi veya degerlendirmesi gerektiginde |
| **Neden** | Mesa Diagnostic islemini standartlastirmak icin |
...
Nerede: `ai\safety\mesa-diagnostic.md`
Ne Zaman: AI modeli secimi veya degerlendirmesi gerektiginde
Neden: Mesa Diagnostic islemini standartlastirmak ve tekrarlanabilir kilmak icin
