...
|:----:|:---------|
| **Kim** | AI muhendisi |
| **Ne** | Audit an LLM prompt template and traffic pattern for cacheability. Recommend prompt restructure, TTL choice, parallelization fix, and semantic-cache threshold. |
| **Nerede** | `ai\ecc\cache-auditor.md` |
| **Ne Zaman** | AI modeli secimi veya degerlendirmesi gerektiginde |
| **Neden** | Cache Auditor islemini standartlastirmak icin |
...
Nerede: `ai\ecc\cache-auditor.md`
Ne Zaman: AI modeli secimi veya degerlendirmesi gerektiginde
Neden: Cache Auditor islemini standartlastirmak ve tekrarlanabilir kilmak icin
