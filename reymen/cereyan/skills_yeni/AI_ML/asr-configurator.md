...
| **Ne** | Pick an ASR model (Whisper variant / Moonshine / faster-whisper) and decoding parameters for a new speech pipeline. |
| **Nerede** | `voice\asr-configurator.md` |
| **Ne Zaman** | Ses isleme veya TTS/STT gerektiginde |
| **Neden** | Asr Configurator islemini standartlastirmak icin |
...
Nerede: `voice\asr-configurator.md`
Ne Zaman: Ses isleme veya TTS/STT gerektiginde
Neden: Asr Configurator islemini standartlastirmak ve tekrarlanabilir kilmak icin
