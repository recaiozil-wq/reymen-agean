...
|:----:|:---------|
| **Kim** | AI muhendisi |
| **Ne** | Persistent per-project memory for Claude Code. Auto-loads project context on session start, tracks sessions with git activity, and writes to native memory. Commands run deterministic Node.js scripts — |
| **Nerede** | `ai\ecc\ecc_ck.md` |
| **Ne Zaman** | AI modeli secimi veya degerlendirmesi gerektiginde |
| **Neden** | Ecc Ck islemini standartlastirmak icin |
...
|:-----|:------|
| **Kim?** | Tüm ajanlar |
| **Ne?** | Persistent per-project memory for Claude Code. Auto-loads project context on session start, tracks sessions with git activity, and writes to native memory. Commands run deterministic Node.js scripts — behavior is consistent across model versions. |
| **Nerede?** | ecc/ |
...
Nerede: `ai\ecc\ecc_ck.md`
Ne Zaman: AI modeli secimi veya degerlendirmesi gerektiginde
Neden: Ecc Ck islemini standartlastirmak ve tekrarlanabilir kilmak icin
