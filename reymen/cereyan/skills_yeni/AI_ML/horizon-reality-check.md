...
|:----:|:---------|
| **Kim** | ML/Veri bilimci |
| **Ne** | Given a task you want to hand to an agent, decide whether the current frontier's horizon covers it with enough margin. |
| **Nerede** | `mlops\horizon-reality-check.md` |
| **Ne Zaman** | ML modeli egitimi veya deploy gerektiginde |
| **Neden** | Horizon Reality Check islemini standartlastirmak icin |
...
Nerede: `mlops\horizon-reality-check.md`
Ne Zaman: ML modeli egitimi veya deploy gerektiginde
Neden: Horizon Reality Check islemini standartlastirmak ve tekrarlanabilir kilmak icin
