...
|:----:|:---------|
| **Kim** | AI muhendisi |
| **Ne** | Produce a CI/CD-ready benchmark recipe that gates LLM deploys on goodput, not throughput, with P50/P90/P99 percentiles and a documented tool choice. |
| **Nerede** | `ai\safety\slo-goodput-gate.md` |
| **Ne Zaman** | AI modeli secimi veya degerlendirmesi gerektiginde |
| **Neden** | Slo Goodput Gate islemini standartlastirmak icin |
...
Nerede: `ai\safety\slo-goodput-gate.md`
Ne Zaman: AI modeli secimi veya degerlendirmesi gerektiginde
Neden: Slo Goodput Gate islemini standartlastirmak ve tekrarlanabilir kilmak icin
