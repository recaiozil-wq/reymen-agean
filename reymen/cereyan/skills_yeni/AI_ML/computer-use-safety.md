...
|:----:|:---------|
| **Kim** | AI muhendisi |
| **Ne** | Build per-step safety classifier + confirmation gate for a computer-use agent, with allowlist navigation and injection-marker filtering. |
| **Nerede** | `ai\safety\computer-use-safety.md` |
| **Ne Zaman** | AI modeli secimi veya degerlendirmesi gerektiginde |
| **Neden** | Computer Use Safety islemini standartlastirmak icin |
...
Nerede: `ai\safety\computer-use-safety.md`
Ne Zaman: AI modeli secimi veya degerlendirmesi gerektiginde
Neden: Computer Use Safety islemini standartlastirmak ve tekrarlanabilir kilmak icin
