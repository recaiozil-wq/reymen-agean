...
|:----:|:---------|
| **Kim** | ML/Veri bilimci |
| **Ne** | Pick a production runtime shape (request-response, streaming, queue, event, cron, durable) and wire observability. |
| **Nerede** | `mlops\inference\runtime-shape.md` |
| **Ne Zaman** | ML modeli egitimi veya deploy gerektiginde |
| **Neden** | Runtime Shape islemini standartlastirmak icin |
...
Nerede: `mlops\inference\runtime-shape.md`
Ne Zaman: ML modeli egitimi veya deploy gerektiginde
Neden: Runtime Shape islemini standartlastirmak ve tekrarlanabilir kilmak icin
