...
|:----:|:---------|
| **Kim** | AI muhendisi |
| **Ne** | Identify which fairness criterion a claim invokes and audit the associated assumptions. |
| **Nerede** | `ai\ecc\fairness-criterion.md` |
| **Ne Zaman** | AI modeli secimi veya degerlendirmesi gerektiginde |
| **Neden** | Fairness Criterion islemini standartlastirmak icin |
...
Nerede: `ai\ecc\fairness-criterion.md`
Ne Zaman: AI modeli secimi veya degerlendirmesi gerektiginde
Neden: Fairness Criterion islemini standartlastirmak ve tekrarlanabilir kilmak icin
