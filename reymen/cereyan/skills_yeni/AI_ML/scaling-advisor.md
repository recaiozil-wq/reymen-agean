...
|:----:|:---------|
| **Kim** | ML/Veri bilimci |
| **Ne** | Advise on durable-execution choice for a multi-agent production system. Picks between FastAPI + Postgres, LangGraph runtime, Temporal, Restate, or custom based on concrete load and state-retention nee |
| **Nerede** | `mlops\infrastructure\scaling-advisor.md` |
| **Ne Zaman** | ML modeli egitimi veya deploy gerektiginde |
| **Neden** | Scaling Advisor islemini standartlastirmak icin |
...
|:-----|:------|
| **Kim?** | Tüm ajanlar |
| **Ne?** | Advise on durable-execution choice for a multi-agent production system. Picks between FastAPI + Postgres, LangGraph runtime, Temporal, Restate, or custom based on concrete load and state-retention needs. |
...
Nerede: `mlops\infrastructure\scaling-advisor.md`
Ne Zaman: ML modeli egitimi veya deploy gerektiginde
Neden: Scaling Advisor islemini standartlastirmak ve tekrarlanabilir kilmak icin
