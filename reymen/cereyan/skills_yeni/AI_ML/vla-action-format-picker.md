...
|:----:|:---------|
| **Kim** | AI muhendisi |
| **Ne** | Pick an action format (discrete bin, FAST, flow-matching, dual-system) and VLA family (RT-2, OpenVLA, π0, GR00T) for a robot task. |
| **Nerede** | `ai\multimodal\vla-action-format-picker.md` |
| **Ne Zaman** | AI modeli secimi veya degerlendirmesi gerektiginde |
| **Neden** | Vla Action Format Picker islemini standartlastirmak icin |
...
Nerede: `ai\multimodal\vla-action-format-picker.md`
Ne Zaman: AI modeli secimi veya degerlendirmesi gerektiginde
Neden: Vla Action Format Picker islemini standartlastirmak ve tekrarlanabilir kilmak icin
