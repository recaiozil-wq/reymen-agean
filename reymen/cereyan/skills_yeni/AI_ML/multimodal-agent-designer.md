...
|:----:|:---------|
| **Kim** | AI muhendisi |
| **Ne** | Design a multimodal agent (computer-use, GUI grounding, web or mobile) with action schema, memory strategy, and benchmark evaluation plan. |
| **Nerede** | `ai\multimodal\multimodal-agent-designer.md` |
| **Ne Zaman** | AI modeli secimi veya degerlendirmesi gerektiginde |
| **Neden** | Multimodal Agent Designer islemini standartlastirmak icin |
...
Nerede: `ai\multimodal\multimodal-agent-designer.md`
Ne Zaman: AI modeli secimi veya degerlendirmesi gerektiginde
Neden: Multimodal Agent Designer islemini standartlastirmak ve tekrarlanabilir kilmak icin
