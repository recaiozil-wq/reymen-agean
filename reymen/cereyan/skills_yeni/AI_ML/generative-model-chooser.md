...
|:----:|:---------|
| **Kim** | ML/Veri bilimci |
| **Ne** | Pick a generative-model family, backbone, and hosted alternative for a given task and budget. |
| **Nerede** | `mlops\architecture\generative-model-chooser.md` |
| **Ne Zaman** | ML modeli egitimi veya deploy gerektiginde |
| **Neden** | Generative Model Chooser islemini standartlastirmak icin |
...
Nerede: `mlops\architecture\generative-model-chooser.md`
Ne Zaman: ML modeli egitimi veya deploy gerektiginde
Neden: Generative Model Chooser islemini standartlastirmak ve tekrarlanabilir kilmak icin
