...
|:----:|:---------|
| **Kim** | ML/Veri bilimci |
| **Ne** | Audit a differential-privacy claim for a language-model deployment. |
| **Nerede** | `mlops\dp-audit.md` |
| **Ne Zaman** | ML modeli egitimi veya deploy gerektiginde |
| **Neden** | Dp Audit islemini standartlastirmak icin |
...
Nerede: `mlops\dp-audit.md`
Ne Zaman: ML modeli egitimi veya deploy gerektiginde
Neden: Dp Audit islemini standartlastirmak ve tekrarlanabilir kilmak icin
