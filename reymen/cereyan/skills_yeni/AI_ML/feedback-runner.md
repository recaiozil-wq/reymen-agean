...
|:----:|:---------|
| **Kim** | AI muhendisi |
| **Ne** | Wrap shell commands with deterministic stdout/stderr/exit/duration capture, persist a JSONL record per command, and refuse to advance the agent loop when feedback is missing. |
| **Nerede** | `ai\ecc\feedback-runner.md` |
| **Ne Zaman** | AI modeli secimi veya degerlendirmesi gerektiginde |
| **Neden** | Feedback Runner islemini standartlastirmak icin |
...
Nerede: `ai\ecc\feedback-runner.md`
Ne Zaman: AI modeli secimi veya degerlendirmesi gerektiginde
Neden: Feedback Runner islemini standartlastirmak ve tekrarlanabilir kilmak icin
