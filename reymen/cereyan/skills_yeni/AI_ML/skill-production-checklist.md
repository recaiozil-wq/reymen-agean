...
|:----:|:---------|
| **Kim** | ML/Veri bilimci |
| **Ne** | Decision framework for shipping LLM applications to production -- covers every component with specific thresholds and pass/fail criteria |
| **Nerede** | `mlops\skills\skill-production-checklist.md` |
| **Ne Zaman** | ML modeli egitimi veya deploy gerektiginde |
| **Neden** | Skill Production Checklist islemini standartlastirmak icin |
...
Nerede: `mlops\skills\skill-production-checklist.md`
Ne Zaman: ML modeli egitimi veya deploy gerektiginde
Neden: Skill Production Checklist islemini standartlastirmak ve tekrarlanabilir kilmak icin
