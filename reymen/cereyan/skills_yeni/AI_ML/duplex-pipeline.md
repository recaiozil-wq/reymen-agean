...
|:----:|:---------|
| **Kim** | ML/Veri bilimci |
| **Ne** | Pick full-duplex (Moshi) vs pipeline (VAD + STT + LLM + TTS) architecture for a voice-agent workload. |
| **Nerede** | `mlops\duplex-pipeline.md` |
| **Ne Zaman** | ML modeli egitimi veya deploy gerektiginde |
| **Neden** | Duplex Pipeline islemini standartlastirmak icin |
...
Nerede: `mlops\duplex-pipeline.md`
Ne Zaman: ML modeli egitimi veya deploy gerektiginde
Neden: Duplex Pipeline islemini standartlastirmak ve tekrarlanabilir kilmak icin
