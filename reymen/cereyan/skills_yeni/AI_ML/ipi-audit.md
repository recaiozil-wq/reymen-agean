...
|:----:|:---------|
| **Kim** | AI muhendisi |
| **Ne** | Audit an agentic deployment for indirect prompt injection exposure and information-flow-control coverage. |
| **Nerede** | `ai\ecc\ipi-audit.md` |
| **Ne Zaman** | AI modeli secimi veya degerlendirmesi gerektiginde |
| **Neden** | Ipi Audit islemini standartlastirmak icin |
...
Nerede: `ai\ecc\ipi-audit.md`
Ne Zaman: AI modeli secimi veya degerlendirmesi gerektiginde
Neden: Ipi Audit islemini standartlastirmak ve tekrarlanabilir kilmak icin
