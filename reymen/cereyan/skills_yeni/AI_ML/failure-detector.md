...
|:----:|:---------|
| **Kim** | AI muhendisi |
| **Ne** | Generate failure-mode detectors for agent traces, wired to a trace store, tagging the five industry-recurring modes plus domain-specific signatures. |
| **Nerede** | `ai\ecc\failure-detector.md` |
| **Ne Zaman** | AI modeli secimi veya degerlendirmesi gerektiginde |
| **Neden** | Failure Detector islemini standartlastirmak icin |
...
Nerede: `ai\ecc\failure-detector.md`
Ne Zaman: AI modeli secimi veya degerlendirmesi gerektiginde
Neden: Failure Detector islemini standartlastirmak ve tekrarlanabilir kilmak icin
