...
|:----:|:---------|
| **Kim** | Windows ajani |
| **Ne** | "Windows'ta hata tespiti, kodlama ve cozum yonetimi. 4 bilesen: HataWatchdog (ekran OCR), HataKoduUretici (HATA-XXXX), TerminalHataParser (PowerShell/cmd), CozumUygulayici (patch)." |
| **Nerede** | `windows\troubleshooting\windows-hata-cozumu.md` |
| **Ne Zaman** | Windows sistem yonetimi gerektiginde |
| **Neden** | Windows Hata Cozumu islemini standartlastirmak icin |
...
Nerede: `windows\troubleshooting\windows-hata-cozumu.md`
Ne Zaman: Windows sistem yonetimi gerektiginde
Neden: Windows Hata Cozumu islemini standartlastirmak ve tekrarlanabilir kilmak icin
