...
|:-----|:------|
| **Kim?** | Tüm ajanlar |
| **Ne?** | Initializes hersona persona on first use of a profile and assists in maintaining the applied speech style if deviation is detected during conversation. |
| **Nerede?** | preferences/ |
