...
|:-----|:------|
| **Kim?** | Tüm ajanlar |
| **Ne?** | Operate the Teams meeting summary pipeline via Hermes CLI — summarize meetings, inspect pipeline status, replay jobs, manage Microsoft Graph subscriptions. |
| **Nerede?** | Verimlilik/ |
