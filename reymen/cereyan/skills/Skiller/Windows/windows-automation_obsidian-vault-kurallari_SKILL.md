...
|:-----|:------|
| **Kim?** | Tüm ajanlar |
| **Ne?** | Use whenever reading, writing, or syncing anything to Obsidian. Contains the ONLY correct vault path and startup verification routine. ALWAYS check this skill before any Obsidian file operation. |
| **Nerede?** | Windows/ |
