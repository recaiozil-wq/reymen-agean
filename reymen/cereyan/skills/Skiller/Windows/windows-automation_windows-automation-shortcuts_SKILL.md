...
|:-----|:------|
| **Kim?** | Windows ajanı |
| **Ne?** | Tüm Windows otomasyon script'leri için klavye kısayol atama rehberi + AutoHotkey script. Özel Script olanlara Ctrl+Alt+Harf atar, Windows doğal kısayolu olanları listeler. |
| **Nerede?** | Windows/ |
