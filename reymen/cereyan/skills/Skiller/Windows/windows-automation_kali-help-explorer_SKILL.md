...
|:-----|:------|
| **Kim?** | Kali ajanı |
| **Ne?** | Kali Linux araçlarının yardım/ man/ info sayfalarını analiz eder, parametre matrisi çıkarır, senaryo bazlı örnekler üretir. Kali VM'e SSH bağlantısı ile çalışır. |
| **Nerede?** | Windows/ |
