---
name: user-preferences_terminal-communication_references_sorma-workflow
description: Sorma" Workflow — Doğrudan Uygulama Deseni
title: "User Preferences Terminal Communication References Sorma Workflow"
version: 1.0.0
---
...
|:----:|:---------|
| **Kim** | AI/ML mühendisi |
| **Ne** | Sorma" Workflow — Doğrudan Uygulama Deseni |
| **Nerede** | AI_ML/ |
