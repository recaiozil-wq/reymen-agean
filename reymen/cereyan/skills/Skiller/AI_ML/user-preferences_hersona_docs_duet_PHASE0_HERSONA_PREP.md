---
name: user-preferences-hersona-docs-duet-phase0-hersona-prep
description: '1. `pyproject.toml` メタデータ整備:'
title: User Preferences Hersona Docs Duet Phase0 Hersona Prep
version: 1.0.0
---
