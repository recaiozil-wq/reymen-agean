---
name: software-development-spring-boot-scaffold
description: Spring Boot 3.4.x + JPA + H2 + JWT + Lombok + Validation ile REST API
  scaffold.
title: Software Development Spring Boot Scaffold
version: 1.0.0
---
