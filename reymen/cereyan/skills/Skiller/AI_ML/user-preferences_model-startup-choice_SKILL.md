---
name: user-preferences-model-startup-choice
description: '**ZORUNLU:** Her yeni oturum başladığında, kullanıcının ilk mesajına
  cevap vermeden önce aşağıdaki seçimi sun.'
title: User Preferences Model Startup Choice
version: 1.0.0
---
