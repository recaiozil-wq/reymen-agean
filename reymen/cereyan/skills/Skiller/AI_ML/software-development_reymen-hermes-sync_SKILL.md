---
name: software-development-reymen-hermes-sync
description: When Hermes Agent gets updated, Reymen (a derived project) needs to selectively
  absorb the changes. Not all Hermes files can be blindly copied — Reymen has custom
  modifications, renamed modules, and a different architecture.
title: Software Development Reymen Hermes Sync
version: 1.0.0
---
...
project) while preserving Reymen-specific customizations. Covers 3-step merge, reymen_
  prefix convention, duplicate detection, protected files, and self-update setup.
