---
name: software-development-simplify-code
description: Review your recent code changes with three focused reviewers running
  in
title: Software Development Simplify Code
version: 1.0.0
---
