---
name: workbench-pack
description: Workbench Pack skill for AI/ML operations.
...
to the team's history, scope globs matched to the repo, rubric dimensions extended
  with one domain-specific entry.
