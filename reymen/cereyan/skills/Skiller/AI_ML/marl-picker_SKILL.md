---
name: marl-picker
description: Marl Picker skill for AI/ML operations.
title: Marl Picker
version: 1.0.0
---
...
a given multi-agent task. Consider cooperative vs competitive, action-space type,
  heterogeneity, reward structure, and scale.
