---
name: reviewer-agent
description: Reviewer Agent skill for AI/ML operations.
...
builder artifacts, produces a structured review report, and starts human review
  from a written page instead of a blank one.
