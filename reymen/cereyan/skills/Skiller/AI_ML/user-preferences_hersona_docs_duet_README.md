---
name: user-preferences-hersona-docs-duet-readme
description: '- **言語/ツール**: Python 3.11+ / uv / ruff / pytest。hersona 本体と同一スタイル'
title: User Preferences Hersona Docs Duet Readme
version: 1.0.0
---
