...
description: Hermes memory limiti 50K'ya çıktı ama yine de dolabilir. Her session'da memory'ye eklenen bayat entry'ler (teknik test detayları, eski session notları, tamamlanmış iş kayıtları) zamanla birikir.
...
| **Ne?** | Hermes memory limiti 50K'ya çıktı ama yine de dolabilir. Her session'da memory'ye eklenen bayat entry'ler (teknik test detayları, eski session notları, tamamlanmış iş kayıtları) zamanla birikir. |
| **Nerede?** | AI_ML/agents/ |
