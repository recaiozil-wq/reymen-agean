...
description: Hermes reference test'leri (`tests/ReYMeN_reference/`) import hatasi veriyor veya olmayan API'lere bagimli.
title: "Reymen Test Rewrite Pattern"
tags: [general]
...
| **Ne?** | Hermes reference test'leri (`tests/ReYMeN_reference/`) import hatasi veriyor veya olmayan API'lere bagimli. |
| **Nerede?** | AI_ML/agents/ |
