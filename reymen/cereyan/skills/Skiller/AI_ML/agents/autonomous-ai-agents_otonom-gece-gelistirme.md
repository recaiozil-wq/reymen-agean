...
| **Ne?** | Gece boyunca çalışan otonom geliştirme döngüsü. Obsidian vault'u tara, eksik skill'leri bul, yeni skill oluştur, mevcutları güncelle/geliştir, sonucu Telegram'a raporla. |
| **Nerede?** | AI_ML/agents/ |
