---
name: software-development-fork-project-audit
description: find "$PROJE" -name "*.py" -not -path "*/venv/*" -not -path "*/__pycache__/*"
  -not -path "*/.git/*" | wc -l
title: Software Development Fork Project Audit
version: 1.0.0
---
...
files, broken import chains, code volume by origin, and produce structured delegation
