...
description: When evaluating a GPT-style model from a technical report, model card,
  or training log, use this framework to break down the architecture and identify
  design tradeoffs.
