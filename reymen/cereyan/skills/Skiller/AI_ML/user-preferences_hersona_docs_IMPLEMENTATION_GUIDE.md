---
name: user-preferences-hersona-docs-implementation-guide
description: hersona は、アニメ・ゲーム風キャラクターの **口調・性格・役割** を「作品に依存しない
title: User Preferences Hersona Docs Implementation Guide
version: 1.0.0
---
