---
name: state-schema
description: State Schema skill for AI/ML operations.
title: State Schema
version: 1.0.0
---
...
a Python StateManager with atomic writes, and a migration scaffold so schema bumps
  cannot corrupt the workbench.
