...
_REYMEN_CORE_TOOLS = _ReYMeN_CORE_TOOLS
        ...
        if name.startswith("ReYMeN-"):
            ...
            try:
                ...
                if platform_registry.is_registered(platform_name):
                    ...
                    except Exception as _toolsets_e679:
                        print(f"[UYARI] toolsets.py:680 - {_toolsets_e679}")
                    return list(plugin_tools)
            except Exception as _toolsets_e682:
                print(f"[UYARI] toolsets.py:683 - {_toolsets_e682}")
