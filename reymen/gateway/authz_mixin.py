...
that uses it (``from reymen.gateway.run import logger`` resolves at call time, when
...
from reymen.gateway.whatsapp_identity import (
...
class GatewayAuthorizationMixin:
    ...
    def _is_user_authorized(self, source: SessionSource) -> bool:
        ...
        5. Default: deny
        """
        from reymen.gateway.run import logger
