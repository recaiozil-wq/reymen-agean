...
import pytest
import reymen.sistem.plugin_loader as _modul
...
def test_tool_pluginlerini_yukle():
    ...
    try:
        ...
        pytest.skip('Arguman gerekli: reymen.sistem.plugin_loader.tool_pluginlerini_yukle')
    except Exception as hata:
        pytest.xfail('Runtime hatasi: ' + str(hata))
...
def test_hafiza_pluginlerini_yukle():
    ...
    try:
        ...
        pytest.skip('Arguman gerekli: reymen.sistem.plugin_loader.hafiza_pluginlerini_yukle')
    except Exception as hata:
        pytest.xfail('Runtime hatasi: ' + str(hata))
...
def test_aktif_hafiza_saglayici():
    ...
    try:
        ...
        pytest.skip('Arguman gerekli: reymen.sistem.plugin_loader.aktif_hafiza_saglayici')
    except Exception as hata:
        pytest.xfail('Runtime hatasi: ' + str(hata))
...
def test_hafiza_saglayici_listele():
    ...
    try:
        ...
        pytest.skip('Arguman gerekli: reymen.sistem.plugin_loader.hafiza_saglayici_listele')
    except Exception as hata:
        pytest.xfail('Runtime hatasi: ' + str(hata))
