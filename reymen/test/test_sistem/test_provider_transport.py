...
import pytest
import reymen.sistem.provider_transport as _modul
...
def test_aktif_saglayicilar():
    ...
    try:
        ...
        pytest.skip('Arguman gerekli: reymen.sistem.provider_transport.aktif_saglayicilar')
    except Exception as hata:
        pytest.xfail('Runtime hatasi: ' + str(hata))
...
def test_tum_saglayicilar():
    ...
    try:
        ...
        pytest.skip('Arguman gerekli: reymen.sistem.provider_transport.tum_saglayicilar')
    except Exception as hata:
        pytest.xfail('Runtime hatasi: ' + str(hata))
