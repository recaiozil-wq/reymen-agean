...
import pytest
import reymen.sistem.baslangic_kontrol as _modul
...
def test_api_anahtari_var_mi():
    ...
    try:
        ...
        pytest.skip('Arguman gerekli: reymen.sistem.baslangic_kontrol.api_anahtari_var_mi')
...
def test_lmstudio_modeller():
    ...
    try:
        ...
        pytest.skip('Arguman gerekli: reymen.sistem.baslangic_kontrol.lmstudio_modeller')
    except Exception as hata:
        pytest.xfail('Runtime hatasi: ' + str(hata))
...
def test_ollama_calisiyor_mu():
    ...
    try:
        ...
        pytest.skip('Arguman gerekli: reymen.sistem.baslangic_kontrol.ollama_calisiyor_mu')
    except Exception as hata:
        pytest.xfail('Runtime hatasi: ' + str(hata))
...
def test_baslangic_kontrolu():
    ...
    try:
        ...
        pytest.skip('Arguman gerekli: reymen.sistem.baslangic_kontrol.baslangic_kontrolu')
    except Exception as hata:
        pytest.xfail('Runtime hatasi: ' + str(hata))
