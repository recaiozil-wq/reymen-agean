...
class JsonBackend(MemoryProvider):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        """Oturumu baslatir; reymen_home verilirse dosya yolunu gunceller."""
...
class SQLiteBackend(MemoryProvider):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        """Oturumu baslatir; reymen_home verilirse db yolunu gunceller."""
        self._session_id = session_id
        hermes_home = kwargs.get("hermes_home")
    ...
    def kapat(self) -> None:
        ...
        try:
            ...
            logger.warning("[MemoryProvider] except Exception (L615): %s", Exception)
            pass
