"""
ReYMeN MCP Server — expose messaging conversations as MCP tools.
...
Plus: channels_list (ReYMeN-specific extra)

Usage:
    reymen mcp serve
    reymen mcp serve --verbose
...
logger = logging.getLogger("reymen.mcp_serve")
...
class EventBridge:
    ...
    This is the ReYMeN equivalent of OpenClaw's WebSocket gateway bridge.
...
def create_mcp_server(event_bridge: Optional[EventBridge] = None) -> "FastMCP":
    ...
    mcp = FastMCP(
        "reymen",
        instructions=(
            "ReYMeN Agent messaging bridge. Use these tools to interact with "
