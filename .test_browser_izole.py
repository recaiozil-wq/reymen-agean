...
try:
    ...
    import traceback
    hatalar.append(("Adim 4-6", "TIMEOUT: _sayfa_al() 15sn sonra donmedi! sync_playwright().start() 2. kez cagrildiginda bloke oldu."))
    sonuclar["t2"] = {
        "test": "Kapatma sonrasi yenileme",
        "beklenen": "C saglikli, C != A",
...
print("|------|----------|-------------|-------|")
for k in ["t1","t2","t3"]:
    v = sonuclar.get(k, {"test": k, "beklenen": "-", "gerceklesen": "CALISTIRILAMADI", "durum": "❌"})
