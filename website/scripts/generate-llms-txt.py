#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the ReYMeN docs site.
...
Both publish at:
  https://ReYMeN-agent.nousresearch.com/docs/llms.txt
  https://ReYMeN-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://ReYMeN-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use ReYMeN as a Python Library", None),
        ("guides/use-mcp-with-ReYMeN", "Use MCP with ReYMeN", None),
        ("guides/use-voice-mode-with-ReYMeN", "Use Voice Mode with ReYMeN", None),
        ("guides/use-soul-with-ReYMeN", "Use SOUL.md with ReYMeN", None),
        ("guides/build-a-ReYMeN-plugin", "Build a ReYMeN Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with ReYMeN"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "ReYMeN-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/ReYMeN-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# ReYMeN Agent — Full Documentation\n",
        (
            "This file is the entire ReYMeN Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using ReYMeN, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://ReYMeN-agent.nousresearch.com/docs\n",
        "Short index: https://ReYMeN-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
