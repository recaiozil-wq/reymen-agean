---
name: user-preferences-hersona-docs-duet-phase1-handoff
description: '- **hersona 側 Phase 0 は完了済み**。`v0.0.1` リリース済み。duet が依存する公開 API'
title: User Preferences Hersona Docs Duet Phase1 Handoff
version: 1.0.0
---
