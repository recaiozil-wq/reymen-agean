---
name: user-preferences-3lu-kontrol-sistemi
description: '**ZORUNLU:** Her görev tamamlandığında bu skill çalıştırılır. Atlanamaz.'
title: User Preferences 3Lu Kontrol Sistemi
version: 1.0.0
---
...
yapıldı mı (3) kayıt doğru girildi mi'
