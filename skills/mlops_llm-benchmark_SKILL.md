---
name: llm-benchmark
description: Elimizdeki tüm LLM'leri (DeepSeek, Groq, Ollama) aynı test seti üzerinde
  çalıştırıp hız, doğruluk, tutarlılık ve maliyet açısından sıralar.
title: Llm Benchmark
version: 1.0.0
---
...
acisindan test eder. Yeni model eklendiginde guncelle.
