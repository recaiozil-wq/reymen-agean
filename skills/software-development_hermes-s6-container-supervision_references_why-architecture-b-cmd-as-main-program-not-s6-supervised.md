---
name: software-development_hermes-s6-container-supervision_references_why-architecture-b-cmd-as-main-program-not-s6-supervised
description: Why Architecture B (CMD as main program, not s6-supervised)
title: "Software Development Hermes S6 Container Supervision References Why Architecture B Cmd As Main Program Not S6 Supervised"
version: 1.0.0
---
...
|:----:|:---------|
| **Kim** | AI/ML mühendisi |
| **Ne** | Why Architecture B (CMD as main program, not s6-supervised) |
| **Nerede** | AI_ML/ |
