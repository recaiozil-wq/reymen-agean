...
│   ├── hermes-agent/           # ReYMeN konfigürasyonu
│   ├── mcp/                    # MCP client
...
- Asıl ReYMeN okuma yeri: `AppData\Local\hermes\skills\` — burada da skill'ler doğrudan ana dizinde (iç içe skills/skills/ olmaz)
