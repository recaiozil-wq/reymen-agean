...
`agents/hermes/manifest.yaml` — ReYMeN'in NemoClaw içindeki resmi konfigürasyon haritası:
...
`agents/hermes/validate-env-secret-boundary.py` (6.7 KB) — ReYMeN .env'sinde secret sızıntısını kontrol eden Python scripti. Direkt alınıp kullanılabilir.
...
| Hmbown/NemoReYMeN | NVIDIA capability registry + Spark routing |
