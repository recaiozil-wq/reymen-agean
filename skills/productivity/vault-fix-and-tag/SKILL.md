...
- `ReYMeN/Skills/**/*.md` → `#hermes #skill`
- `ReYMeN/Skills/<kategori>/**/*.md` → `#hermes #skill #<kategori>`
- `ReYMeN/Topics/**/*.md` → `#hermes`
- `ReYMeN/Knowledge/**/*.md` → `#hermes #knowledge`
- Kök `ReYMeN/*.md` → `#hermes`
