...
description: Birden çok LLM'i aynı test seti üzerinde çalıştırıp **hız (ms), doğruluk
  (%), tutarlılık ve hata oranı** ölçer. Çıktıyı Obsidian vault'unda referans tablosu
  olarak saklar.
...
metriği. Yeni model geldiğinde veya mevcut model performansını ölçmek için tekrarlanabilir
  pipeline.
