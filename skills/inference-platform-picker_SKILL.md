...
description: Inference Platform Picker skill for AI/ML operations.
...
Anyscale, or custom silicon) given workload, SLA, budget, and operational constraints.
  Normalize per-token, per-minute, and per-prediction pricing.
