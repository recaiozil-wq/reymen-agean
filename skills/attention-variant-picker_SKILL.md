...
description: Help a developer choose and justify an attention topology for a new transformer,
  or for an existing one they're extending to longer context.
...
for a new model given context length, retrieval demands, and compute profile.
