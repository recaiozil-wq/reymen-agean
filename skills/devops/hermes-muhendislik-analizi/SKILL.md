...
title: ReYMeN Mühendislik Analizi
description: "ReYMeN Agent'in tam mimari analizi — 4 paralel ajan + video analizi ile üretilmiş kapsamlı referans dokümanı."
...
# ReYMeN Mühendislik Analizi (Modüler Router)

Bu skill, ReYMeN Agent'in tam mimari analiz dokümanını 7 bağımsız referans dosyasına bölen modüler bir yönlendiricidir.
...
|-------|------|------------------|
| Bölüm 1 | Genel Mimari & ReYMeN Nedir | `references/01-genel-mimari.md` |
