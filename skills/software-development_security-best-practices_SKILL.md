---
name: software-development-security-best-practices
description: This skill provides a description of how to identify the language and
  frameworks used by the current context, and then to load information from this skill's
