...
| Startup link | `%APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup\ReYMeN_Tor_Temizleme.lnk` | Her Windows açılışında otomatik tetikler |
...
### Startup Akışı
1. Windows açılır
2. Startup klasöründeki `ReYMeN_Tor_Temizleme.lnk` tetiklenir
...
## Kaldırma
- Startup: `ReYMeN_Tor_Temizleme.lnk` sil
