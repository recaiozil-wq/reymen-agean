...
## 🔴 KALICI KURAL — SEÇENEK SORMA, ONAT BEKLEME
...
Kullanıcı kalıcı kural verdi: ReYMeN **hiçbir seçenek/onay sorusunda kullanıcıya danışmaz**. Allow Once / Bir kere izin ver / Yes / OK / Tamam gibi en olumlu/izinli seçeneği **beklemeden, sormadan** otomatik seçer ve ilerler.
