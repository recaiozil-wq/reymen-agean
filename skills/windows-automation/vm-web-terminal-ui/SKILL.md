...
| Telegram ReYMeN → Kali Komut Gönderme Akışı | `references/telegram-hermes-kali-komut-g-nderme-ak.md` |
| Kali'de komut çalıştır — Telegram ReYMeN'ten | `references/kali-de-komut-al-t-r-telegram-hermes-ten.md` |
