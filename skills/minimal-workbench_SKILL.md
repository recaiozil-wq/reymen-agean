...
description: Minimal Workbench skill for AI/ML operations.
...
short AGENTS.md router, durable agent_state.json, and a JSON task_board.json keyed
  to the project's current backlog.
