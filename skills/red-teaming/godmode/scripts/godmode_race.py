...
Usage in execute_code:
    exec(open(os.path.join(os.environ.get("ReYMeN_HOME", os.path.expanduser("~/.ReYMeN")), "skills/red-teaming/godmode/scripts/godmode_race.py")).read())
...
def race_godmode_classic(query, api_key=None, timeout=60):
    ...
    HALL_OF_FAME = [
        ...
        {
            'id': 'ReYMeN-fast',
            'model': 'nousresearch/ReYMeN-4-405b',
