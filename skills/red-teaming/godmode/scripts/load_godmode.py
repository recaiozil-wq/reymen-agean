...
Usage in execute_code:
    exec(open(os.path.expanduser(
        os.path.join(os.environ.get("ReYMeN_HOME", os.path.expanduser("~/.ReYMeN")), "skills/red-teaming/godmode/scripts/load_godmode.py")
    )).read())
...
_gm_scripts_dir = Path(os.getenv("ReYMeN_HOME", Path.home() / ".ReYMeN")) / "skills" / "red-teaming" / "godmode" / "scripts"
