---
name: software-development-spring-boot-microservice-scaffold
description: 'Spring Boot 3.4.x + Spring Cloud 2024 ile 5 servisli mikroservis mimarisi:'
title: Software Development Spring Boot Microservice Scaffold
version: 1.0.0
---
