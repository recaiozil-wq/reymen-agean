...
description: Managed Platform Picker skill for AI/ML operations.
...
second for redundancy, given workload, SLA, and compliance requirements — then produce
  a FinOps instrumentation plan.
