...
description: Rollout Runbook skill for AI/ML operations.
...
or prompt template, with five canary gates, noise-floor-aware thresholds, and a
  seconds-fast rollback path.
