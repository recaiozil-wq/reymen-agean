---
name: brand-voice
description: Build a durable voice profile from real source material, then use that
  profile everywhere instead of re-deriving style from scratch or defaulting to generic
  AI copy.
title: Brand Voice
version: 1.0.0
---
