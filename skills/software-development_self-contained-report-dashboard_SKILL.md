---
name: software-development-self-contained-report-dashboard
description: '- User shares a `.HTM` / `.HTML` file that is a self-contained data
  reporting dashboard'
title: Software Development Self Contained Report Dashboard
version: 1.0.0
---
...
Chart.js + SheetJS (xlsx.js). Excel-based data ingestion, pie/bar/line charts, tabular
  views, and auto-generated commentary.
