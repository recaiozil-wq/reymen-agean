...
> **For large-scale import resolution** (100+ failures across a test suite), see [references/bulk-import-resolution.md](references/bulk-import-resolution.md). It covers systematic categorization and per-type fixes: pip install, conftest stubs, root shim creation, Unix-only module handling, and parsing artifact filtering.
...
- [references/bulk-import-resolution.md](references/bulk-import-resolution.md) — resolve hundreds of ImportErrors across a large test suite by systematic categorization and per-type fix strategy (pip install, conftest stubs, root shims, sub-agent stub creation)
