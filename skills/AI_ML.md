...
description: "ReYMeN'in geceleri kendi kendine Obsidian vault + ReYMeN skills tarayarak gelişmesi: eksik notları skill'e dönüştür, güncel olmayan skill'leri güncelle, isim çakışmalarını çöz, senkronizasyonu doğrula."
...
- MCP filesystem ile `Obsidian Vault\ReYMeN\Skills\` altında yeni dosyaları kontrol et
